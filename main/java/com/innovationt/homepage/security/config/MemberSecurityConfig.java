...
import com.innovationt.homepage.security.auth.MemberPrincipalDetailService;
import com.innovationt.homepage.security.provider.MemberAuthenticatorProvider;
            ...
            try {
                authorize
                        .requestMatchers("/css/**", "/images/**", "/js/**"
                        				, "/member/login/**", "/member/attachment/**", "/member/files/**"
                        				,"/member/signUpForm/**","/member/signup/**"
                        				)
